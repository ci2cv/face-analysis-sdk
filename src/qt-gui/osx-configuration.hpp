...
#ifndef _CI2CV_GUI_OSX_CONFIGURATION_HPP_
#define _CI2CV_GUI_OSX_CONFIGURATION_HPP_
...
namespace CI2CVGui {
	class OSXConfiguration : public Configuration
	{
	public:
		OSXConfiguration();
